---
title: "Bean Validation в Spring Boot 3 на практике"
author: ""
type: ""
...
private: false
---
Статья демонстрирует основные возможности [Bean Validation](https://beanvalidation.org/) интегрированные в Spring Boot на практических примерах.
<!--more-->
