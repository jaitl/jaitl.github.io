...
## Senior Software Engineer, October 2019 to Present
## [aScaper](https://ascraper.com/), Russia, Moscow
Я один из сооснователей стартапа. Вместе с командой я проектировал архитектуру, разрабатывал MVP, а затем выводил проекты компании в продакшен.
